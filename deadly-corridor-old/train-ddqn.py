...
if __name__ == '__main__':
    ...
    model_path = './checkpoints/' + opt.name + '.pth'
    
    config_path = os.path.join(vzd.scenarios_path, opt.config)

    # Initialize game and actions
    game = create_game(config_path)
